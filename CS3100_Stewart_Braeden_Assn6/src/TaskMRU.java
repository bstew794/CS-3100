...
public class TaskMRU implements Runnable{
    ...
    public TaskMRU(int[] sequence, int maxMemoryFrames, int maxPageReference, int[] pageFaults, CountDownLatch latch){
                ...
                if (frames.size() < maxMemoryFrames){
                    ...
                    if (!frames.contains(page)){
                        ...
                        while (integerIterator.hasNext()){
                            ...
                            if (pagesMap.get(temp) > youngest){
                                youngest = pagesMap.get(temp);
                                num = temp;
                            }
                        }
                        frames.remove(num);
